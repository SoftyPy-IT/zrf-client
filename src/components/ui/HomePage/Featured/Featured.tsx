...
const Featured = () => {
  ...
  //   {
  //     title: "Komol Seed",
  //     description: "The farmers of our country contribute a major part.",
  //     imageUrl: img1,
  //   },
  //   {
  //     title: "Komol Water",
  //     description: "To supply pure water among the people.",
  //     imageUrl: img1,
  //   },
  //   {
    ...
    <Container>
      <div className="lg:relative -top-24 z-10">
        <div className="bg-white lg:p-2 shadow-md lg:mt-0 mt-10">
          <Slider {...settings}>
            {cardsData.map((program, index) => (
              <div key={index} className="flex justify-center items-center p-2">
                <div className="flex gap-5 bg-green-600 p-3 lg:h-full h-[150px]">
                  <div className="space-y-3 flex-1">
                    ...
                    <Link href={`/our-projects/${program.id}`}>
      ...
      {/* Styling for the slick arrow buttons with background color */}
      <style jsx global>{`
        .slick-prev {
          left: 0;
