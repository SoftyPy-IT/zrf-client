            ...
            <div className="w-full -mt-[330px] ">
              <div className="text-white">
                ...
                <p className="text-center lg:w-[500px] mx-auto mb-10">
                  ...
                  Ziaur Rahman Foundations is committed to empowering communities through impactful initiatives, sustainable solutions, and strategic support. We focus on fostering growth, improving lives, and creating lasting change across various sectors.
                </p>
              </div>
              <Slider {...settings}>
