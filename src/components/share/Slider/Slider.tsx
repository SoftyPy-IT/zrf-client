...
const slides = [
  {
    ...
    description:
      "একটি উদ্যোগ, একটু চেষ্টা, এনে দিবে স্বচ্ছলতা, দেশে আসবে স্বনির্ভরতা। আমাদের লক্ষ্য সমাজের প্রতিটি মানুষের জন্য সুযোগ সৃষ্টি করা, যাতে তারা নিজের পায়ে দাঁড়াতে পারে এবং দেশকে সমৃদ্ধির দিকে এগিয়ে নিয়ে যেতে পারে।",
        ...
        {slides.map((slide, index) => (
          <SwiperSlide key={index} className="swiper-slide-zoom">
            <div className="relative w-full h-[400px] lg:h-[700px] sliderWrap">
              ...
              <div
                className={`absolute z-[99999999] inset-0 flex justify-center items-center text-center text-white p-4 transition-all duration-1000 ease-in-out ${
                  activeSlide === index
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-28"
                }`}
              >
                <div className="w-[700px] lg:bg-black md:bg-black md:bg-opacity-50 lg:bg-opacity-50 p-5 rounded-lg">
